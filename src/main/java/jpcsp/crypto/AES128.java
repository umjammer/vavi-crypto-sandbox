...
public class AES128 {
    ...
    private static final Logger log = Logger.getLogger(AES128.class.getName());
    ...
    public static void init() {
    	...
    	Executors.newSingleThreadExecutor().submit(() -> init("AES/CBC/NoPadding"));
    }
    ...
    private static void init(String mode) {
        if (cipher == null) {
            ...
            try {
                ...
                log.log(Level.SEVERE, "AES128 Cipher", e);
            }
        }
    }
    ...
    public byte[] encrypt(byte[] in, Key keySpec, byte[] iv) {
        ...
        try {
        	...
        	log.log(Level.SEVERE, "encrypt", e);
        }
    ...
    public byte[] decrypt(byte[] in, byte[] decKey, byte[] iv) {
        ...
        try {
            ...
            log.log(Level.SEVERE, "decrypt", e);
        }
